...
namespace grafy
{
    class Graph
    {
     ...
     /*ниже методы для курсовой мне нужны*/
        ...
        public int[,] Stradanie()
        {
            SortedList<int, object> references;
            int[,] mas = GetMas(out references);
            //int n = mas.Length;

            //SortedList<int, int> a = new SortedList<int, int>();
            List<int> a = new List<int>();
            // SortedList<int, int> b = new SortedList<int, int>();
            List<int> b = new List<int>();
            SortedList<int, int> tempi = new SortedList<int, int>();
            SortedList<int, int> tempj = new SortedList<int, int>();
            List<int> right = new List<int>();
            List<int> left = new List<int>();

            bool shouldDoStep2 = true;
